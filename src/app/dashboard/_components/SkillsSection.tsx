...
function SkillsSection({ portfolio, onUpdate }: SkillsSectionProps) {
  ...
  const popularSkills = [
    { name: 'JavaScript', logo: 'https://cdn.jsdelivr.net/npm/simple-icons@v9/icons/javascript.svg', type: 'Programming Language' },
    { name: 'TypeScript', logo: 'https://cdn.jsdelivr.net/npm/simple-icons@v9/icons/typescript.svg', type: 'Programming Language' },
    { name: 'React', logo: 'https://cdn.jsdelivr.net/npm/simple-icons@v9/icons/react.svg', type: 'Framework' },
    { name: 'Node.js', logo: 'https://cdn.jsdelivr.net/npm/simple-icons@v9/icons/nodedotjs.svg', type: 'Framework' },
    { name: 'Python', logo: 'https://cdn.jsdelivr.net/npm/simple-icons@v9/icons/python.svg', type: 'Programming Language' },
    { name: 'Java', logo: 'https://cdn.jsdelivr.net/npm/simple-icons@v9/icons/java.svg', type: 'Programming Language' },
    { name: 'C++', logo: 'https://cdn.jsdelivr.net/npm/simple-icons@v9/icons/cplusplus.svg', type: 'Programming Language' },
    { name: 'C#', logo: 'https://cdn.jsdelivr.net/npm/simple-icons@v9/icons/csharp.svg', type: 'Programming Language' },
    { name: 'PHP', logo: 'https://cdn.jsdelivr.net/npm/simple-icons@v9/icons/php.svg', type: 'Programming Language' },
    { name: 'Go', logo: 'https://cdn.jsdelivr.net/npm/simple-icons@v9/icons/go.svg', type: 'Programming Language' },
    { name: 'Rust', logo: 'https://cdn.jsdelivr.net/npm/simple-icons@v9/icons/rust.svg', type: 'Programming Language' },
    { name: 'Swift', logo: 'https://cdn.jsdelivr.net/npm/simple-icons@v9/icons/swift.svg', type: 'Programming Language' },
    { name: 'Kotlin', logo: 'https://cdn.jsdelivr.net/npm/simple-icons@v9/icons/kotlin.svg', type: 'Programming Language' },
    { name: 'Vue.js', logo: 'https://cdn.jsdelivr.net/npm/simple-icons@v9/icons/vuedotjs.svg', type: 'Framework' },
    { name: 'Angular', logo: 'https://cdn.jsdelivr.net/npm/simple-icons@v9/icons/angular.svg', type: 'Framework' },
    { name: 'Next.js', logo: 'https://cdn.jsdelivr.net/npm/simple-icons@v9/icons/nextdotjs.svg', type: 'Framework' },
    { name: 'Express.js', logo: 'https://cdn.jsdelivr.net/npm/simple-icons@v9/icons/express.svg', type: 'Framework' },
    { name: 'Django', logo: 'https://cdn.jsdelivr.net/npm/simple-icons@v9/icons/django.svg', type: 'Framework' },
    { name: 'Flask', logo: 'https://cdn.jsdelivr.net/npm/simple-icons@v9/icons/flask.svg', type: 'Framework' },
    { name: 'Spring', logo: 'https://cdn.jsdelivr.net/npm/simple-icons@v9/icons/spring.svg', type: 'Framework' },
    { name: 'MongoDB', logo: 'https://cdn.jsdelivr.net/npm/simple-icons@v9/icons/mongodb.svg', type: 'Database' },
    { name: 'PostgreSQL', logo: 'https://cdn.jsdelivr.net/npm/simple-icons@v9/icons/postgresql.svg', type: 'Database' },
    { name: 'MySQL', logo: 'https://cdn.jsdelivr.net/npm/simple-icons@v9/icons/mysql.svg', type: 'Database' },
    { name: 'Redis', logo: 'https://cdn.jsdelivr.net/npm/simple-icons@v9/icons/redis.svg', type: 'Database' },
    { name: 'Docker', logo: 'https://cdn.jsdelivr.net/npm/simple-icons@v9/icons/docker.svg', type: 'DevOps' },
    { name: 'Kubernetes', logo: 'https://cdn.jsdelivr.net/npm/simple-icons@v9/icons/kubernetes.svg', type: 'DevOps' },
    { name: 'AWS', logo: 'https://cdn.jsdelivr.net/npm/simple-icons@v9/icons/amazonaws.svg', type: 'Cloud Platform' },
    { name: 'Azure', logo: 'https://cdn.jsdelivr.net/npm/simple-icons@v9/icons/microsoftazure.svg', type: 'Cloud Platform' },
    { name: 'Google Cloud', logo: 'https://cdn.jsdelivr.net/npm/simple-icons@v9/icons/googlecloud.svg', type: 'Cloud Platform' },
    { name: 'Git', logo: 'https://cdn.jsdelivr.net/npm/simple-icons@v9/icons/git.svg', type: 'Tool' },
    { name: 'GitHub', logo: 'https://cdn.jsdelivr.net/npm/simple-icons@v9/icons/github.svg', type: 'Tool' },
    { name: 'GitLab', logo: 'https://cdn.jsdelivr.net/npm/simple-icons@v9/icons/gitlab.svg', type: 'Tool' },
    { name: 'Linux', logo: 'https://cdn.jsdelivr.net/npm/simple-icons@v9/icons/linux.svg', type: 'Tool' },
    { name: 'Figma', logo: 'https://cdn.jsdelivr.net/npm/simple-icons@v9/icons/figma.svg', type: 'Tool' },
    { name: 'Adobe Photoshop', logo: 'https://cdn.jsdelivr.net/npm/simple-icons@v9/icons/adobephotoshop.svg', type: 'Tool' },
    { name: 'Adobe Illustrator', logo: 'https://cdn.jsdelivr.net/npm/simple-icons@v9/icons/adobeillustrator.svg', type: 'Tool' },
    { name: 'Tailwind CSS', logo: 'https://cdn.jsdelivr.net/npm/simple-icons@v9/icons/tailwindcss.svg', type: 'Framework' },
    { name: 'Bootstrap', logo: 'https://cdn.jsdelivr.net/npm/simple-icons@v9/icons/bootstrap.svg', type: 'Framework' },
    { name: 'HTML5', logo: 'https://cdn.jsdelivr.net/npm/simple-icons@v9/icons/html5.svg', type: 'Programming Language' },
    { name: 'CSS3', logo: 'https://cdn.jsdelivr.net/npm/simple-icons@v9/icons/css3.svg', type: 'Programming Language' },
    { name: 'Sass', logo: 'https://cdn.jsdelivr.net/npm/simple-icons@v9/icons/sass.svg', type: 'Tool' },
    { name: 'Webpack', logo: 'https://cdn.jsdelivr.net/npm/simple-icons@v9/icons/webpack.svg', type: 'Tool' },
    { name: 'Vite', logo: 'https://cdn.jsdelivr.net/npm/simple-icons@v9/icons/vite.svg', type: 'Tool' },
    { name: 'Jest', logo: 'https://cdn.jsdelivr.net/npm/simple-icons@v9/icons/jest.svg', type: 'Tool' },
    { name: 'Cypress', logo: 'https://cdn.jsdelivr.net/npm/simple-icons@v9/icons/cypress.svg', type: 'Tool' },
    // Soft skills
    { name: 'Leadership', logo: '', type: 'Soft Skill' },
    { name: 'Communication', logo: '', type: 'Soft Skill' },
    { name: 'Problem Solving', logo: '', type: 'Soft Skill' },
    { name: 'Team Collaboration', logo: '', type: 'Soft Skill' },
    { name: 'Project Management', logo: '', type: 'Soft Skill' },
    { name: 'Time Management', logo: '', type: 'Soft Skill' },
  ]
